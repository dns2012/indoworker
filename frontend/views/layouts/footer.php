<footer class="footer container container-palette">
            ...
            <div class="row row-flex">
                <div class="col-md-3">
                    <div class="f_widget widget-about">
                        ...
                        <div class="body">test XXX sed est in lorem luctus hendrit. Nulla in posuere neque. Nam lectus risus, pellentesque at nulla vitae, mauris raesent pulvinar.</div><!-- ./ widget body -->
                    </div><!-- ./ widget about -->
                </div>
                <div class="col-md-3">
                    <div class="f_widget widget-navigation">
                        ...
                        <div class="body">
                            <ul class="list-f-nav">
                                <li><a href="<? echo Url::to(['layouts/Jobs_search'])?>;"><i class="arrow_carrot-right_alt2"></i>Find Jobs</a></li>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="flex-row">
                <div class="right"><span class="copyright">Copyright © 2019 - KerjaLN.com</span></div><!-- ./ copyright -->
                <div class="left">
