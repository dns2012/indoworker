 ...
 *
 */
class BioJobConfirmedController extends Controller
{
  ...
  function actionIndex($id=0) {
    ...
    $dataJobPostActivity =  (new \yii\db\Query())
                            ...
                            ->andWhere(['job_post_activity.trash' => 0])
                            ->all();
  ...
  function actionMovetotrash($id=0,$menu=0) {
    ...
    $model->save();
    return $this->redirect(['/bio-job-confirmed?id='.$menu]);
  }
