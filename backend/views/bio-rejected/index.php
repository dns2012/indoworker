...
$this->title = 'Applicant Rejected';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="bio-rejected-index">
      ...
      <tbody>
        <?php foreach($dataJobPostActivity as $index => $data) { ?>
          <tr>
            ...
            <!-- <td>
              <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#modalMoveToTrash<?=$index+1?>">Recall</button>
            </td> -->
          </tr>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <a href="<?/*= Url::to(['bio-rejected/rejected?id='.$data['id'].'&menu='.$jobType['job_type_id']]) */ ?>" class="btn btn-danger">Recall</a>
