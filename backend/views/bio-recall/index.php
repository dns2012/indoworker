...
$this->title = 'Applicant Recall';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="bio-job-recall-index">
      ...
      <tbody>
        <?php foreach($dataJobPostActivity as $index => $data) { ?>
          <tr>
            ...
            <!-- <td>
              <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#modalMoveToTrash<?=$index+1?>"></button>
            </td> -->
          </tr>
